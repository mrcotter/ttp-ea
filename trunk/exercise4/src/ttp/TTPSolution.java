...
public class TTPSolution {
    ...
    public ArrayList<Node> packList;
...
*/
    ...
    public void generatePlanList(int[] packPlan) {

        packList = new ArrayList<Node>();
                
        for(int i = 0; i < packPlan.length; i++)
        {
        	Node node = new Node(packPlan[i]);
        	packList.add(node);
        }
